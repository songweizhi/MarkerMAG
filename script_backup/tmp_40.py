...
def sankey_linkages(combined_linkage_file_ctg_level, linkage_plot_rd1_html, linkage_plot_rd2_html):
    ...
    plot_height_rd1 = 700 if max([len(contig_set_rd1), len(marker_gene_set_rd1)]) <= 25 else max([len(contig_set_rd1), len(marker_gene_set_rd1)]) * 30
    plot_height_rd2 = 700 if max([len(contig_set_rd2), len(marker_gene_set_rd2)]) <= 25 else max([len(contig_set_rd2), len(marker_gene_set_rd2)]) * 30
...
combined_linkage_file_ctg_level = '/Users/songweizhi/Desktop/GI_0416_identified_linkages_contig_level.txt'
linkage_plot_rd1_html           = '/Users/songweizhi/Desktop/GI_0416_identified_linkages_contig_level_rd1.html'
linkage_plot_rd2_html           = '/Users/songweizhi/Desktop/GI_0416_identified_linkages_contig_level_rd2.html'
