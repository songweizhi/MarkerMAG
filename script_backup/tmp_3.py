...
link_stats_paired               = '%s/stats_paired.txt' % wd
link_stats_paired_filtered      = '%s/stats_paired_filtered.txt' % wd
...
min_linkages = 10
min_linkages_for_uniq_linked_16s = 5

pairwise_16s_iden_dict = blast_results_to_pairwise_16s_iden_dict(blast_results_all_vs_all_16s, aln16s, cov16s)

filter_linkages_iteratively(link_stats_paired, 'Number', pairwise_16s_iden_dict, mean_depth_dict_gnm, mean_depth_dict_16s, min_16s_gnm_multiple, within_genome_minimum_iden16s, min_linkages, min_linkages_for_uniq_linked_16s, link_stats_paired_filtered)
