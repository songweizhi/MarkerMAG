...
'''
large_insert_size_paired_read_num	50  22216	25.53
small_insert_size_paired_read_num	50  64819	74.47

large_insert_size_paired_read_num	100 12164	13.98
small_insert_size_paired_read_num	100 74871	86.02

large_insert_size_paired_read_num	150 6421	7.38
small_insert_size_paired_read_num	150 80614	92.62

large_insert_size_paired_read_num	200 3272	3.76
small_insert_size_paired_read_num	200 83763	96.24
...
pwd_sam_file_filtered_random        = '/Users/songweizhi/Desktop/666/000/%s_all_mis%s_minM%s_IS%s_filtered_random.sam'  % (sam_basename, mismatch_cutoff, min_M_len_16s, min_insert_size)
if both_pair_mapped is True:
    ...
    pwd_sam_file_filtered_random    = '/Users/songweizhi/Desktop/666/000/%s_both_mis%s_minM%s_IS%s_filtered_random.sam' % (sam_basename, mismatch_cutoff, min_M_len_16s, min_insert_size)

#pwd_sam_mp_file = '/Users/songweizhi/Desktop/666/000/reads_16s_to_16s_sam_all_both_mis2_minM70_mr_subset.txt'
...
with open(pwd_sam_mp_file) as each_mp_file_opened:
    for each_read_base in each_mp_file_opened:
        ...
        # print(current_read_base___r1_16s_ref_dict)
        # print(current_read_base___r2_16s_ref_dict)
        # print(current_read_base___r1_16s_refs_no_ignored)
        # print(current_read_base___r2_16s_refs_no_ignored)
        # print(current_read_base___shared_16s_refs_no_ignored)
        # print()
        ...
        if len(current_read_base___shared_16s_refs_no_ignored) > 0:
            ...
            for each_shared_ref in current_read_base___shared_16s_refs_no_ignored:
                #print(each_shared_ref)
                #if (len(current_read_base___r1_16s_ref_dict[each_shared_ref]) == 1) and (len(current_read_base___r2_16s_ref_dict[each_shared_ref]) == 1):
