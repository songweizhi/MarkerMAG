...
wd                      = '/Users/songweizhi/Desktop/assess_linkages_Pig'
bin_id_file             = '%s/pig_322_MAGs.txt'                                                    % wd
barrnap_output          = '%s/pig_322_MAGs_16S.txt'                                                % wd
mean_depth_file         = '%s/pig_322_MAGs_mean_depth.txt'                                         % wd
gtdb_gnm_to_ssu_txt     = '%s/GTDB_ssu_all_r202_gnm_to_ssu.txt'                                    % wd
seq_file_16s            = '%s/Pig_1-25_16S_uclust_0.999.QC.fasta'                                  % wd
checkm_output           = '%s/pig_322_MAGs_quality_reformatted.txt'                                % wd
taxonomy_mag            = '%s/pig_322_MAGs.summary.tsv'                                            % wd

taxonomy_16s            = '%s/Pig_1-25_16S_uclust_0.999.QC_vs_GTDB_classifications.txt'            % wd
taxonomy_16s_blca       = '%s/Pig_1-25_16S_uclust_0.999.QC_blca_vs_gtdb.txt'                       % wd
taxonomy_16s_silva      = '%s/Pig_1-25_16S_uclust_0.999.QC_vs_SILVA_r138_classifications.txt'      % wd
taxonomy_16s_silva_blca = '%s/Pig_1-25_16S_uclust_0.999.QC_blca_vs_silva_r138.txt'                 % wd

linkage_file            = '%s/Pig_0912_linkages_by_genome.txt'         % wd
