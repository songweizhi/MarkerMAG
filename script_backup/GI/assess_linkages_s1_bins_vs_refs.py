...
linkage_txt         = '%s/stats_linkage_%s.txt'      % (wd, iden_cutoff)
bin_to_ref_txt      = '%s/stats_bin_to_ref_%s.txt'   % (wd, iden_cutoff)
ref_to_bin_txt      = '%s/stats_ref_to_bin_%s.txt'   % (wd, iden_cutoff)
aln_len_cutoff      = 1500
cov_q_cutoff        = 90
